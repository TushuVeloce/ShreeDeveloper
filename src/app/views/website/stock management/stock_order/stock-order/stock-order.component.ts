...
export class StockOrderComponent implements OnInit {
  ...
  headerswithoutsite: string[] = ['PO ID', 'Date', 'Vendor', 'Material', 'Unit', 'Requisition Qty', 'Ordered Qty', 'Extra Ordered Qty', 'Requisition Remaining Qty', 'Discount Rate', 'Delivery Date', 'Total Amount', 'Grand Total', 'Status', 'Action & Print'];
