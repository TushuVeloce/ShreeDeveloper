...
export class QuotationComponent implements OnInit {
  ...
  headers: string[] = ['Site', 'Date', 'Vendor', 'Material', 'Unit', 'Required Quantity', 'Quotation Quantity', 'Required Remaining Quantity', 'Discount Rate', 'Delivery Date', 'Total Amount', 'Grand Total', 'Status', 'Action'];
  headerswithoutsite: string[] = ['Date', 'Vendor', 'Material', 'Unit', 'Required Quantity', 'Quotation Quantity', 'Required Remaining Quantity', 'Discount Rate', 'Delivery Date', 'Total Amount', 'Grand Total', 'Status', 'Action'];
  constructor(
