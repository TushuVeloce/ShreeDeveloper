...
@Component({
  selector: 'app-invoice-print-preview-mobile',
  templateUrl: './invoice-print-preview-mobile.page.html',
  styleUrls: ['./invoice-print-preview-mobile.page.scss'],
  standalone:false
})
export class InvoicePrintPreviewMobilePage implements OnInit {
