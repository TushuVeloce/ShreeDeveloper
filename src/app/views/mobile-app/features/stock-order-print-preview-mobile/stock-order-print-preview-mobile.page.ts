...
@Component({
  selector: 'app-stock-order-print-preview-mobile',
  templateUrl: './stock-order-print-preview-mobile.page.html',
  styleUrls: ['./stock-order-print-preview-mobile.page.scss'],
  standalone: false,
})
export class StockOrderPrintPreviewMobilePage implements OnInit {
