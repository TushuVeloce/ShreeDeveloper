...
@Component({
  selector: 'app-site-expenses-details-mobile',
  templateUrl: './site-expenses-details-mobile.page.html',
  styleUrls: ['./site-expenses-details-mobile.page.scss'],
  standalone: false
})
export class SiteExpensesDetailsMobilePage implements OnInit {
