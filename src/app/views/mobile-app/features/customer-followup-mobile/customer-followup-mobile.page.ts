...
@Component({
  selector: 'app-customer-followup-mobile',
  templateUrl: './customer-followup-mobile.page.html',
  styleUrls: ['./customer-followup-mobile.page.scss'],
  standalone:false
})
export class CustomerFollowupMobilePage implements OnInit {
  ...
  async onAddCustomerEnquiry() {
    await this.router.navigate(['mobileapp/tabs/dashboard/customer-relationship-management/customer-followup/edit']);
  }
  formatData = (list: any[]) => {
