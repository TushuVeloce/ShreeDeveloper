...
@Component({
  selector: 'app-site-expenses-print-preview-mobile',
  templateUrl: './site-expenses-print-preview-mobile.page.html',
  styleUrls: ['./site-expenses-print-preview-mobile.page.scss'],
  standalone:false
})
export class SiteExpensesPrintPreviewMobilePage implements OnInit {
