...
@Component({
  selector: 'app-customer-enquiry-details-mobile',
  templateUrl: './customer-enquiry-details-mobile.page.html',
  styleUrls: ['./customer-enquiry-details-mobile.page.scss'],
  standalone:false
})
export class CustomerEnquiryDetailsMobilePage implements OnInit {
