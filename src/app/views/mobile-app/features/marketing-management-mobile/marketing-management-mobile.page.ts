...
@Component({
  selector: 'app-marketing-management-mobile',
  templateUrl: './marketing-management-mobile.page.html',
  styleUrls: ['./marketing-management-mobile.page.scss'],
  standalone:false
})
export class MarketingManagementMobilePage implements OnInit {
  ...
  onEditClicked = async (item: MarketingManagement) => {
    ...
    await this.router.navigate(['mobileapp/tabs/dashboard/marketing-management/edit']);
  };
  ...
  async AddMarketing() {
    try {
      ...
      this.router.navigate(['mobileapp/tabs/dashboard/marketing-management/add']);
    } catch (error: any) {
