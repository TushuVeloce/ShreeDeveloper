...
@Component({
  ...
  templateUrl: './forgot-password-mobile.page.html',
  styleUrls: ['./forgot-password-mobile.page.scss'],
  standalone: false
})
export class ForgotPasswordMobilePage implements OnInit, OnDestroy {
