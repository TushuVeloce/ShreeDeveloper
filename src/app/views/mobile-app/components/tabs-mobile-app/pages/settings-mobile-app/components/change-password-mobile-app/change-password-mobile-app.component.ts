...
@Component({
  selector: 'app-change-password-mobile-app',
  templateUrl: './change-password-mobile-app.component.html',
  styleUrls: ['./change-password-mobile-app.component.scss'],
  standalone: false
})
export class ChangePasswordMobileAppComponent implements OnInit {
  ...
  onUpdatePassword = async () => {
    if (this.passwordForm.valid) {
      ...
      this.router.navigate(['mobile-app/tabs/settings']);
