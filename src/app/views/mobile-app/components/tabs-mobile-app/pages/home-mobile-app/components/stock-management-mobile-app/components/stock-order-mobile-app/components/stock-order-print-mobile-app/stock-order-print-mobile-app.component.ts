...
@Component({
  selector: 'app-stock-order-print-mobile-app',
  templateUrl: './stock-order-print-mobile-app.component.html',
  styleUrls: ['./stock-order-print-mobile-app.component.scss'],
  standalone:false
})
export class StockOrderPrintMobileAppComponent  implements OnInit {
