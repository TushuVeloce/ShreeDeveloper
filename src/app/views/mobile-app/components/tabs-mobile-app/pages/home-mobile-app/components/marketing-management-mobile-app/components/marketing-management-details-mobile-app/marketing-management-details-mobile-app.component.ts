...
@Component({
  selector: 'app-marketing-management-details-mobile-app',
  templateUrl: './marketing-management-details-mobile-app.component.html',
  styleUrls: ['./marketing-management-details-mobile-app.component.scss'],
  standalone:false
})
export class MarketingManagementDetailsMobileAppComponent  implements OnInit {
  ...
  SaveMarketingManagementMaster = async () => {
    ...
    if (!tr.Successful) {
      ...
      if (this.IsNewEntity) {
        ...
        this.Entity = MarketingManagement.CreateNewInstance();
        this.router.navigate(['/mobile-app/tabs/dashboard/marketing-management']);
      } else {
  ...
  goBack = async () => {
    ...
    if (isDataFilled) {
      await this.uiUtils.showConfirmationMessage(
        ...
        async () => {
          this.router.navigate(['/mobile-app/tabs/dashboard/marketing-management'], { replaceUrl: true });
        }
      );
    } else {
      this.router.navigate(['/mobile-app/tabs/dashboard/marketing-management'], { replaceUrl: true });
