...
import { OrderInvoiceMaterialFetchRequest } from "./orderinvoicematerialfetchrequest";


export class OrderInvoiceMaterialDetailProps {
  ...
  public static Blank() {
    return new OrderInvoiceMaterialDetailProps(true);
  }
}
...
export class OrderMaterial implements IPersistable<OrderMaterial> {
  ...
  public constructor(public readonly p: OrderInvoiceMaterialDetailProps, public readonly AllowEdit: boolean) {
  ...
  public GetEditableVersion(): OrderMaterial {
    let newState: OrderInvoiceMaterialDetailProps = Utils.GetInstance().DeepCopy(this.p);
    return OrderMaterial.CreateInstance(newState, true);
  }

  public static CreateNewInstance() {
    return new OrderMaterial(OrderInvoiceMaterialDetailProps.Blank(), true);
  }

  public static CreateInstance(data: any, allowEdit: boolean) {
    return new OrderMaterial(data as OrderInvoiceMaterialDetailProps, allowEdit);
  }
  ...
  public static async FetchTransportData(req: OrderInvoiceMaterialFetchRequest, errorHandler: (err: string) => Promise<void> = UIUtils.GetInstance().GlobalUIErrorHandler) {
  ...
  public static async FetchInstance(ref: number, errorHandler: (err: string) => Promise<void> = UIUtils.GetInstance().GlobalUIErrorHandler) {
    let req = new OrderInvoiceMaterialFetchRequest();
  ...
  public static async FetchList(req: OrderInvoiceMaterialFetchRequest, errorHandler: (err: string) => Promise<void> = UIUtils.GetInstance().GlobalUIErrorHandler) {
    let tdResponse = await OrderMaterial.FetchTransportData(req, errorHandler) as TransportData;
