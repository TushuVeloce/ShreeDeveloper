...
export class InvoiceProps {
  ...
  public ExpenseTypeArray: number[] = []
...
export class Invoice implements IPersistable<Invoice> {
  ...
  public CheckSaveValidity(_td: TransportData, vra: ValidationResultAccumulator): void {
    ...
    if (this.p.ExpenseTypeArray.length <= 0) { vra.add('ExpenseType', 'Expense Type cannot be blank.'); }
  ...
  public static async FetchRecipientByRecipientTypeRef(CompanyRef: number, SiteRef: number, RecipientType: number, errorHandler: (err: string) => Promise<void> = UIUtils.GetInstance().GlobalUIErrorHandler) {
