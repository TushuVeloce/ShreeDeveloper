...
export class BaseUrlService {
  ...
  public GenerateBaseUrl() {
    ...
    let baseURLstring = `http://172.20.16.1:5100/api`; //For Frontend Developers laptop 1
  ...
  public GenerateImageBaseUrl() {
    ...
    let ImageBaseUrl: string ='http://172.20.16.1:5100/api/Request/uploadeddocumentpath/'; //For Frontend Developers 1 Laptop 1
