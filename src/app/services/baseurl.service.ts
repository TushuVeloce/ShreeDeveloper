...
export class BaseUrlService {
  ...
  public GenerateBaseUrl() {
    ...
    let baseURLstring = `http://192.168.1.31:5100/api`; //For Frontend Developers laptop 1
  ...
  public GenerateImageBaseUrl() {
    ...
    let ImageBaseUrl: string ='http://192.168.1.31:5100/api/Request/uploadeddocumentpath/'; //For Frontend Developers 1 Laptop 1
