...
export class BaseUrlService {
  ...
  public GenerateBaseUrl() {
    ...
    let baseURLstring = `http://192.168.175.59:5100/api`;  //For Frontend Developers laptop 1
    ...
    let ImageBaseUrl: string = "http://192.168.175.59:5100/api/Request/uploadeddocumentpath/";  //For Frontend Developers 1 Laptop 1
