...
export class BaseUrlService {
  ...
  public GenerateBaseUrl() {
    ...
    let baseURLstring = `https://psapi.shreedeevelopers.com/api`;
  ...
  public GenerateImageBaseUrl() {
    ...
    // let ImageBaseUrl: string ='http://192.168.29.80:5100/api/Request/uploadeddocumentpath/'; //For Frontend Developers 1 Laptop 1
    ...
    let ImageBaseUrl: string = "https://psapi.shreedeevelopers.com/api/Request/uploadeddocumentpath/";
